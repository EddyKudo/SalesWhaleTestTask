	...
	<div className="my-5 invest mx-auto">
		...
		<div className="mx-auto mt-5">
			<div className="row text-center">
				<div className="col-1" />
				<div className="col-5 border border-info mr-3">
					<img
				...
				<div className="col-5 border border-info ml-3">
			...
			<div className="row text-center my-4">
				<div className="col-1" />
				<div className="col-5 border border-info py-5 mr-3">
					<img
				...
				<div className="col-5 border border-info py-5 ml-3">
