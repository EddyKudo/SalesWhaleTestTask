	...
	<div className="py-5 invest ">
		...
		<div className="mx-auto mt-5">
			<div className="row text-center ">
				<div className="col-1" />
				<div
					className="col-xl-5 col-md-5 col-xs-12 border border-light rounded mr-3 bg-white"
				...
				<div
					className="col-xl-5 col-md-5 col-xs-12 border border-light rounded ml-3 bg-white"
					style={{ boxShadow: "0px 10px 30px -5px #3e4244" }}>
			...
			<div className="row text-center my-4">
				<div className="col-1" />
				<div
					className="col-xl-5 col-md-5 col-xs-12 border border-light rounded py-5 mr-3 bg-white"
					style={{ boxShadow: "0px 10px 30px -5px #3e4244" }}>
					<img
				...
				<div
					className="col-xl-5 col-md-5 col-xs-12 border border-light rounded py-5 ml-3 bg-white"
					style={{ boxShadow: "0px 10px 30px -5px #3e4244" }}>
