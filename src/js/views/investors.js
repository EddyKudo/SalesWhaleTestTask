	...
	<div className="py-5 invest ">
		...
		<div className="mx-auto mt-5">
			<div className="row text-center ">
				<div className="col-1" />
				<div className="col-xl-5 col-md-5 col-xs-12 border border-info rounded mr-3 bg-white">
					<img
				...
				<div className="col-xl-5 col-md-5 col-xs-12 border border-info rounded ml-3 bg-white">
			...
			<div className="row text-center my-4">
				<div className="col-1" />
				<div className="col-xl-5 col-md-5 col-xs-12 border border-info rounded py-5 mr-3 bg-white">
					<img
				...
				<div className="col-xl-5 col-md-5 col-xs-12 border border-info rounded py-5 ml-3 bg-white">
